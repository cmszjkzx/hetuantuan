            ...
            <tr>
                ...
                <td style="vertical-align: middle;font-size: 14px;font-weight: bold;width:100px">状态</td>	<td>
                    <select name="isstatus">
                        ...
                        <option value="3" <?php  echo $isstatus==3?'selected':'';?>>已收货</option>
                    </select>
                </td>
            </tr>
            <tr>
    ...
    <table  id="TabOrders" class="table table-striped table-bordered table-hover">
        ...
        <?php  if(is_array($list)) { foreach($list as $item) { ?>
            ...
            <tr>
                ...
                <td><?php  $countmoney=$countmoney+$item['price']?>
                    <?php  echo $item['price'];?>
                    <?php  if(!empty($item['dispatchprice'])&&$item['dispatchprice']>0 ) { ?>&nbsp;(运费：
                ...
                <td><?php  if($item['paytype'] == 1) { ?>
                    ...
                    <?php  if($item['paytype'] == 2) { ?>
                        <span class="label label-important">在线支付</span>
                    <?php  } ?><?php  if($item['paytype'] == 3) { ?>
