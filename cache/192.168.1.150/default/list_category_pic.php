...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="http://192.168.1.150/hetuantuan/themes/default/__RESOURCE__/css/list_category_view.css">
<style type="text/css">
...
.WX_search_txt, .hd_search_txt {
    background-image: url(http://192.168.1.150/hetuantuan/themes/default/__RESOURCE__/css/images/icon_ss.png)
}
...
<body>
   ...
   <img src="<?php echo WEBSITE_ROOT;?>/attachment/<?php echo $categorypitem['thumb']; ?>" >
    ...
    <?php } ?>
     ...
     <img src="<?php if(!empty($cates['thumb'])){ ?><?php echo WEBSITE_ROOT;?>/attachment/<?php echo $cates['thumb']; ?><?php }else{ ?>http://192.168.1.150/hetuantuan/themes/default/__RESOURCE__/images/blank.png<?php } ?>" >
...
<script src="http://192.168.1.150/hetuantuan/themes/default/__RESOURCE__/js/jquery-1.11.3.min.js" type="text/javascript"></script>
