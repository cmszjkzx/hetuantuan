...
<head>
	...
	<script type="text/javascript" src="http://hetuantuan.ngrok.cc/hetuantuan/themes/default/__RESOURCE__/mobile/script/bootstrap.min.js"></script>
	...
	<link type="text/css" rel="stylesheet" href="http://hetuantuan.ngrok.cc/hetuantuan/themes/default/__RESOURCE__/style/font-awesome.min.css" />
	...
	<script type="text/javascript" src="http://hetuantuan.ngrok.cc/hetuantuan/themes/default/__RESOURCE__/mobile/default/script/jquery.touchwipe.js"></script>
	<script type="text/javascript" src="http://hetuantuan.ngrok.cc/hetuantuan/themes/default/__RESOURCE__/mobile/default/script/swipe.js"></script>
    <style type='text/css'>
...
<div class="myoder">
	...
	<div class="myoder-detail">
		<a href="<?php echo mobile_url('detail', array('id' => $goods['id']))?>">
            <img src="<?php echo WEBSITE_ROOT;?>/attachment/<?php echo $goods['thumb'];?>" width="160">
        </a>
		<div class="pull-left">
