...
.head{height:60px; line-height:60px;  padding:5px; 5px; color:#fff;border-bottom: 1px solid #a5d7de;  background: #5babe6 !important;}
...
<div class="head">
	<a href="<?php echo mobile_url('myorder', array('orderid' => $item['id'], 'op' => 'detail','fromstatus'=>intval($_GP['fromstatus'])))?>" class="bn pull-left"><</a>
	<span class="title">商品评论</span>
	<a href="#"  class="bn pull-right"></a>
</div>
<style>
...
<form class="form-horizontal img-rounded" role="form" method="post" onsubmit="return checkInfo(this);">
	...
	<label for="realname" class="col-sm-3 control-label">评级</label>
	<div class="col-sm-9">
<input type="radio" name="rate" value="2">好评&nbsp;&nbsp;
<input type="radio" name="rate" value="1" checked>中评&nbsp;&nbsp;差评
<input type="radio" name="rate" value="0" >
	</div>
</div>
<div class="form-group">
	<label for="realname" class="col-sm-3 control-label">内容</label>
	<div class="col-sm-9">
...
<div class="form-group">
	<div class="col-xs-12">
		<button type="submit" name="submit" value="yes" class="btn btn-primary btn-lg" style="width:100%;">提交评论</button>
	</div>
</div>
<div class="form-group">
	<div class="col-xs-12">
	<p class="text-center" style="clear:both">
	<a href="<?php echo mobile_url('myorder', array('orderid' => $item['id'], 'op' => 'detail','fromstatus'=>intval($_GP['fromstatus'])))?>">返回订单</a>
  </p>
	</div>
</div>
</form>
