...
<head>
 ...
 <meta name="viewport" content="initial-scale=1.0,maximum-scale=1.0,user-scalable=no">
	...
	<script type="text/javascript" src="http://localhost/hetuantuan/themes/default/__RESOURCE__/mobile/script/bootstrap.min.js"></script>
...
<div class="main">
<script type="text/javascript" src="http://localhost/hetuantuan/themes/default/__RESOURCE__/mobile/images/jquery.gcjs.js"></script>
...
<div style='text-align:center;padding:50px 0 50px 0; <?php if(count($list)>0) { ?>display:none<?php } ?>' id='cartempty'>
    <img src="http://localhost/hetuantuan/themes/default/__RESOURCE__/mobile/images/icon_cart_empty.png" /><br/><br/>
