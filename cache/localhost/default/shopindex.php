...
<head>
    ...
    <link rel="stylesheet" href="http://localhost/hetuantuan/themes/default/__RESOURCE__/css/bootstrap.min.css" type="text/css"/>
    <link rel="stylesheet" href="http://localhost/hetuantuan/themes/default/__RESOURCE__/css/base.css" type="text/css"/>
    <link rel="stylesheet" href="http://localhost/hetuantuan/themes/default/__RESOURCE__/css/iconfont.css"/>
    <link rel="stylesheet" href="http://localhost/hetuantuan/themes/default/__RESOURCE__/css/list.css" type="text/css"/>
    <script type="text/javascript" src="http://localhost/hetuantuan/themes/default/__RESOURCE__/js/jquery-1.11.3.min.js"></script>
    <script type="text/javascript" src="http://localhost/hetuantuan/themes/default/__RESOURCE__/script/remsetting.js"></script>
</head>
<body>
    ...
    <!--<div class="row ptb10">-->
        <!--<div class="col-xsl-2">-->
            <!--<a href="&lt;!&ndash;@php  echo mobile_url('goodlist')@&ndash;&gt;">-->
                <!--<img class="img-responsive" src="http://localhost/hetuantuan/themes/default/__RESOURCE__/images/t1.jpg" style="display: inline;">-->
                <!--<span>全部商品</span>-->
            <!--</a>-->
        <!--</div>-->
    <!--<div class="col-xsl-2">-->
            <!--<a href="&lt;!&ndash;@php  echo mobile_url('myorder',array('status'=>99))@&ndash;&gt;">-->
                <!--<img class="img-responsive" src="http://localhost/hetuantuan/themes/default/__RESOURCE__/images/t6.png" style="display: inline;">-->
                <!--<span>我的订单</span>-->
            <!--</a>-->
        <!--</div>-->
        ...
        <!--<div class="col-xsl-2">-->
            <!--<a href="&lt;!&ndash;@php  echo mobile_url('bonus')@&ndash;&gt;">-->
                <!--<img class="img-responsive" src="http://localhost/hetuantuan/themes/default/__RESOURCE__/images/t5.png" style="display: inline;">-->
                <!--<span>优惠券</span>-->
            <!--</a>-->
        <!--</div>-->
        ...
        <!--<div class="col-xsl-2">-->
            <!--<a href="&lt;!&ndash;@php  echo mobile_url('help')@&ndash;&gt;">-->
                <!--<img class="img-responsive" src="http://localhost/hetuantuan/themes/default/__RESOURCE__/images/t2.png" style="display: inline;">-->
                <!--<span>购物须知</span>-->
            <!--</a>-->
        <!--</div>-->
