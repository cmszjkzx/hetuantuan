...
{
	$sql =$sql."
	delete from `hetuantuan_rule` where `modname`='weixin' and `moddo`='weixin';
insert into `hetuantuan_rule` (`moddescription`,`modname`,`moddo`)value('微信设置','weixin','weixin');
	";
...
{
	$sql =$sql."
	delete from `hetuantuan_rule` where `modname`='alipay' and `moddo`='alipay';
	insert into `hetuantuan_rule` (`moddescription`,`modname`,`moddo`)value('支付宝服务窗设置', 'alipay', 'alipay');
	";
		$user_list = mysqld_selectall("SELECT * FROM " . table('user') );
	foreach ($user_list as &$_tuser) {
...
{
	$sql =$sql."
	delete from `hetuantuan_rule` where `modname`='bonus' and `moddo`='bonus';
insert into `hetuantuan_rule` (`moddescription`,`modname`,`moddo`)value('促销管理','bonus','bonus');
	";
	$user_list = mysqld_selectall("SELECT * FROM " . table('user') );
	foreach ($user_list as &$_tuser) {
...
$sql = $sql."
update `hetuantuan_shop_order` set paytype=1 where paytypecode='gold';
update `hetuantuan_shop_order` set paytype=3 where paytypecode='delivery';
update `hetuantuan_shop_order` set paytype=2 where paytypecode='weixin';
update `hetuantuan_shop_order` set paytype=2 where paytypecode='alipay';
update `hetuantuan_shop_order` set paytype=2 where paytypecode='bank';
...
CREATE TABLE IF NOT EXISTS  `hetuantuan_shop_goods_comment` (
  `createtime` int(10) NOT NULL,
...
CREATE TABLE IF NOT EXISTS  `hetuantuan_shop_pormotions` (
...
CREATE TABLE IF NOT EXISTS  `hetuantuan_gold_teller` (
  `createtime` int(10) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `hetuantuan_gold_order` (
  `createtime` int(10) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `hetuantuan_shop_diymenu` (
...
CREATE TABLE IF NOT EXISTS `hetuantuan_rank_model` (
...
CREATE TABLE IF NOT EXISTS `hetuantuan_rank_phb` (
...
CREATE TABLE IF NOT EXISTS `hetuantuan_bonus_type` (
...
CREATE TABLE IF NOT EXISTS `hetuantuan_bonus_user` (
...
CREATE TABLE IF NOT EXISTS `hetuantuan_bonus_good` (
...
CREATE TABLE IF NOT EXISTS `hetuantuan_alipay_rule` (
...
CREATE TABLE IF NOT EXISTS `hetuantuan_alipay_alifans` (
...
CREATE TABLE IF NOT EXISTS `hetuantuan_shop_dispatch_area` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `hetuantuan_dispatch` (
...
INSERT INTO `hetuantuan_system_rule` (`modname`, `moddo`,`rule_name`) VALUES ('member', 'list', '会员管理');
INSERT INTO `hetuantuan_system_rule` (`modname`, `moddo`,`rule_name`) VALUES ('member', 'rank', '会员等级');
INSERT INTO `hetuantuan_system_rule` (`modname`, `moddo`,`rule_name`) VALUES ('member', 'outchargegold', '余额提现审核');
INSERT INTO `hetuantuan_system_rule` (`modname`, `moddo`,`rule_name`) VALUES ('shop', 'goods', '商品管理');
INSERT INTO `hetuantuan_system_rule` (`modname`, `moddo`,`rule_name`) VALUES ('shop', 'category', '商品分类管理');
INSERT INTO `hetuantuan_system_rule` (`modname`, `moddo`,`rule_name`) VALUES ('shop', 'order', '订单管理');
INSERT INTO `hetuantuan_system_rule` (`modname`, `moddo`,`rule_name`) VALUES ('shop', 'orderbat', '批量发货');
INSERT INTO `hetuantuan_system_rule` (`modname`, `moddo`,`rule_name`) VALUES ('shop', 'goods_comment', '评论管理');
INSERT INTO `hetuantuan_system_rule` (`modname`, `moddo`,`rule_name`) VALUES ('bonus', 'bonus', '优惠券管理');
INSERT INTO `hetuantuan_system_rule` (`modname`, `moddo`,`rule_name`) VALUES ('promotion', 'promotion', '促销免运费');
INSERT INTO `hetuantuan_system_rule` (`modname`, `moddo`,`rule_name`) VALUES ('shopwap', 'ALL', '商城模板');
INSERT INTO `hetuantuan_system_rule` (`modname`, `moddo`,`rule_name`) VALUES ('shop', 'adv', '商城首页广告设置');
INSERT INTO `hetuantuan_system_rule` (`modname`, `moddo`,`rule_name`) VALUES ('bj_tbk', 'setting', '分销模块-基础设置');
INSERT INTO `hetuantuan_system_rule` (`modname`, `moddo`,`rule_name`) VALUES ('bj_tbk', 'agent', '分销模块-代理管理');
INSERT INTO `hetuantuan_system_rule` (`modname`, `moddo`,`rule_name`) VALUES ('bj_tbk', 'commission', '分销模块-佣金审核');
INSERT INTO `hetuantuan_system_rule` (`modname`, `moddo`,`rule_name`) VALUES ('bj_tbk', 'tmessage', '分销模块-消息处理');
INSERT INTO `hetuantuan_system_rule` (`modname`, `moddo`,`rule_name`) VALUES ('bj_tbk', 'spread', '分销模块-海报管理');
INSERT INTO `hetuantuan_system_rule` (`modname`, `moddo`,`rule_name`) VALUES ('bj_tbk', 'phbmedal', '分销模块-粉丝排行头衔管理');
INSERT INTO `hetuantuan_system_rule` (`modname`, `moddo`,`rule_name`) VALUES ('shop', 'config', '商城基础设置');
INSERT INTO `hetuantuan_system_rule` (`modname`, `moddo`,`rule_name`) VALUES ('shop', 'noticemail', '新订单邮件提现');
INSERT INTO `hetuantuan_system_rule` (`modname`, `moddo`,`rule_name`) VALUES ('sms', 'setting', '短信设置');
INSERT INTO `hetuantuan_system_rule` (`modname`, `moddo`,`rule_name`) VALUES ('modules', 'payment', '支付方式设置');
INSERT INTO `hetuantuan_system_rule` (`modname`, `moddo`,`rule_name`) VALUES ('modules', 'thirdlogin', '快捷登陆设置');
INSERT INTO `hetuantuan_system_rule` (`modname`, `moddo`,`rule_name`) VALUES ('modules', 'dispatch', '配送方式设置');
INSERT INTO `hetuantuan_system_rule` (`modname`, `moddo`,`rule_name`) VALUES ('weixin', 'ALL', '微信设置');
INSERT INTO `hetuantuan_system_rule` (`modname`, `moddo`,`rule_name`) VALUES ('alipay', 'ALL', '支付宝服务窗');
INSERT INTO `hetuantuan_system_rule` (`modname`, `moddo`,`rule_name`)  VALUES ('user', 'ALL', '用户管理'); ";
