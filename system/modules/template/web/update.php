...
<?php  include page('header');?>
	<form method="post" class="form-horizontal" enctype="multipart/form-data" >
		...
		<div class="form-group">
			...
			<div class="col-sm-9">
				<?php  if($core_development== 1) { ?>开启&nbsp;&nbsp;&nbsp;
				<a  href="<?php  echo create_url('site', array('name' => 'modules','do' => 'update','act'=>'development','status'=>0))?>"  >
						点此关闭
					</a>
				<?php  } ?>
				<?php  if($core_development== 0) { ?>
					关闭&nbsp;&nbsp;&nbsp;
				<a  href="<?php  echo create_url('site', array('name' => 'modules','do' => 'update','act'=>'development','status'=>1))?>"  >
						点此开启
					</a>
				<?php  } ?>
			</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-9">
				<strong>
					<a  href="<?php  echo create_url('site', array('name' => 'modules','do' => 'checkupdate','act'=>'toupdate'))?>" target="_parent" >
						版本检查升级
					</a>
				</strong>
			</div>
