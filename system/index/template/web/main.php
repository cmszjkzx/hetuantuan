...
<head>
	...
	<title><?php  echo empty($settings['shop_title'])?'和团团':$settings['shop_title'];?></title>
    <link rel="shortcut icon" href="favicon.ico" type="image/x-icon" />
    <meta name="description" content="<?php  echo empty($settings['shop_description'])?'和团团':$settings['shop_description'];?>" />
	<meta name="keywords" content="<?php  echo empty($settings['shop_keyword'])?'和团团':$settings['shop_keyword'];?>">
