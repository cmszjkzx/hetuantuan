      ...
      <?php if(checkrule('member','rank')){ ?>
        <li>
          <a onclick="navtoggle('会员管理 - > 会员等级管理 ')"  href="<?php  echo create_url('site', array('name' => 'member','do' => 'rank'))?>" target="main" >
            <i class="icon-double-angle-right"></i>会员等级
          </a>
        </li>
      <?php }?>
  ...
  <li class="open active">
    ...
    <ul class="submenu">
      ...
      <?php if(checkrule('shop','goods')){ ?>
        <li>
          <a  onclick="navtoggle('商品管理 - > 商品列表')"  href="<?php  echo create_url('site', array('name' => 'shop','do' => 'goods','op'=>'display'))?>" target="main">
            <i class="icon-double-angle-right"></i>商品列表
          </a>
        </li>
        <li>
          <a onclick="navtoggle('商品管理 - > 添加新商品')" href="<?php  echo create_url('site', array('name' => 'shop','do' => 'goods','op'=>'post'))?>" target="main">
            <i class="icon-double-angle-right"></i>添加新商品
          </a>
        </li>

        <li>
          <a onclick="navtoggle('商品管理 - > 商品类别 ')"  href="<?php  echo create_url('site', array('name' => 'shop','do' => 'kinds'))?>" target="main" >
            <i class="icon-double-angle-right"></i>商品类别
          </a>
        </li>

      <?php }?>

      <?php //if(checkrule('shop','kinds')){ ?>
        <!--<li>
          <a onclick="navtoggle('商品管理 - > 商品类别 ')"  href="<?php  echo create_url('site', array('name' => 'shop','do' => 'kinds'))?>" target="main" >
            <i class="icon-double-angle-right"></i>会员等级
          </a>
      ...
      <?php if(checkrule('shop','category')){ ?>
        <li>
          <a onclick="navtoggle('商品管理 - > 管理分类')" href="<?php  echo create_url('site', array('name' => 'shop','do' => 'category','op'=>'display'))?>" target="main">
  ...
  <li class="open active">
    ...
    <ul class="submenu" >
      <?php if(checkrule('shop','order')){ ?>
        <li>
          <a  onclick="navtoggle('订单管理 - > 所有订单')"  href="<?php  echo create_url('site',  array('name' => 'shop','do'=>'order','op' => 'display', 'status' => -99))?>" target="main">
            <i class="icon-double-angle-right"></i>所有订单
          </a>
        </li>
      <?php }?>
      ...
      <?php if(checkrule('shop','orderbat')){ ?>
        <li>
          <a onclick="navtoggle('订单管理 - > 批量发货')" href="<?php  echo create_url('site', array('name' => 'shop','do'=>'orderbat','op' => 'display'))?>" target="main">
            <i class="icon-double-angle-right"></i>批量发货
          </a>
        </li>
      <?php }?>
      ...
      <?php if(checkrule('shop','goods_comment')){ ?>
        <li>
          <a onclick="navtoggle('订单管理 - > 评论管理')" href="<?php  echo create_url('site', array('name' => 'shop','do'=>'goods_comment','op' => 'display'))?>" target="main">
            <i class="icon-double-angle-right"></i>评论管理
          </a>
        </li>
      <?php }?>

      <?php  if(is_array($modulelist)) { foreach($modulelist as $module) { if($module['name']=='addon16'||$module['name']=='addon11'){?>
        <li  class="open">
          <!-- 导航第一级 -->
          <a href="#" class="dropdown-toggle">
  ...
  <li class="open active">
    ...
    <ul class="submenu">
      <?php if(checkrule('bonus','bonus')){ ?>
        <li>
          <a  onclick="navtoggle('促销管理 - > 优惠券管理')"  href="<?php  echo create_url('site', array('name' => 'bonus','do' => 'bonus','op'=>'display'))?>" target="main">
            <i class="icon-double-angle-right"></i>优惠券管理
          </a>
        </li>
      <?php  } ?>
      ...
      <?php if(checkrule('promotion','promotion')){ ?>
        <li>
          <a  onclick="navtoggle('促销管理 - > 促销免运费')"  href="<?php  echo create_url('site', array('name' => 'promotion','do' => 'promotion','op'=>'display'))?>" target="main">
            <i class="icon-double-angle-right"></i>促销免运费
          </a>
        </li>
      <?php  } ?>
  ...
  <li class="open active">
    ...
    <ul class="submenu">
      ...
      <?php if(checkrule('shop','adv')){ ?>
        <li>
          <a  onclick="navtoggle('商城配置 - > 首页广告')"  href="<?php  echo create_url('site', array('name' => 'shop','do' => 'adv','op'=>'display'))?>" target="main">
            <i class="icon-double-angle-right"></i>首页广告
          </a>
        </li>
      <?php  } ?>
    </ul>
