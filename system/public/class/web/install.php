...
\$HETUANTUAN_CONFIG['db']['host'] = '{dbhost}';
\$HETUANTUAN_CONFIG['db']['username'] = '{dbuser}';
\$HETUANTUAN_CONFIG['db']['password'] = '{dbpwd}';
\$HETUANTUAN_CONFIG['db']['port'] = '{dbport}';
\$HETUANTUAN_CONFIG['db']['database'] = '{dbname}';
EOF;
		...
		if ($_GP['doact']=="installsql")
		{
			...
			unset($_SESSION[WEB_SESSION_ACCOUNT]);
			//http_get("http://m.hetuantuan.com/install_log.php?hostname=".urlencode(WEBSITE_ROOT));
