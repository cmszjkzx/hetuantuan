...
<table class="table table-striped table-bordered table-hover" >
	...
	<input name="submit" type="submit" value="批量删除" class="btn btn-primary span3" onclick="return confirm('此操作不可恢复，确认删除？');return false;">
	</th>
...
<?php  if(is_array($bonus_user_list)) { foreach($bonus_user_list as $item) { ?>
	...
	<a class="btn btn-xs btn-info" onclick="return confirm('此操作不可恢复，确认删除？');return false;"  href="<?php  echo create_url('site', array('name' => 'bonus','do' => 'bonusview','op'=>'delete','id'=>$item['bonus_id']))?>"><i class="icon-edit"></i>&nbsp;删&nbsp;除&nbsp;</a>
	</td>
    </tr>
<?php  } } ?>
</table>
