...
<form action="" class="form-horizontal" method="post" onsubmit="return validate()" >
    <table class="table" style="width:95%;" align="center">
        <tbody>
        <tr>
            <td style="vertical-align: middle;font-size: 14px;font-weight: bold;width:120px">手机号码：<input name="send_user_tel" type="text" value="">&nbsp;&nbsp;<input type="submit" name="search_phone" value=" 查 询 手 机" class="btn btn-primary"></td>
        </tr>
        <tr>
            <td style="vertical-align: middle;font-size: 14px;font-weight: bold;width:120px">微信openid：<input name="send_user_weixin" type="text" value="">&nbsp;&nbsp;<input type="submit" name="search_weixin" value=" 查 询 微 信" class="btn btn-primary"></td>
        </tr>
        <tr>
            <td>
                <table cellspacing="1" cellpadding="3">
                    ...
                    <tr>
                        <td align="center" colspan="3">
                            <input type="submit" name="send_user" value="确定发送优惠券" class="btn btn-primary">
                        </td>
                    </tr>
                    </tbody>
                </table>
